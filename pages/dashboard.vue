<template>
    <div>
        <div class="mb-8 space-y-4">
            ...
            <p class="text-muted-foreground font-light text-sm md:text-lg text-center">Chat with the Maricx AI - Explore the power of Maricx AI</p>
        </div>
        <div class="px-4 md:px-20 lg:px-32 space-y-4">
            <div v-for="tool in tools" :key="tool.link" @click="$router.push(`${tool.link}`)"
